...
public class GoogleSheets {
    ...
    public String SPREADSHEETS_ID;
        ...
        public String[] readSheetCol(String range) throws GeneralSecurityException, IOException {
        ...
        public String[] readSheetRow(String range) throws IOException, GeneralSecurityException {
            sheetsService = getSheetsService(APPLICATION_NAME);
            ValueRange response = sheetsService.spreadsheets().values()
                    .get(SPREADSHEETS_ID, range)
                    .execute();
