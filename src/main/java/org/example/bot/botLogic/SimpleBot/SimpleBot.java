...
<<<<<<< Updated upstream:src/main/java/org/example/bot/botLogic/SimpleBot/SimpleBot.java
...
=======
            ...
            "Давайте сохраним интригу?)0))"};
>>>>>>> Stashed changes:src/bot/SimpleBot/SimpleBot.java
